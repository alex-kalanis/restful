...
class Field implements IField
{
    ...
    public static $defaultMessages = [IValidator::EQUAL => 'Please enter %s.', IValidator::MIN_LENGTH => 'Please enter a value of at least %d characters.', IValidator::MAX_LENGTH => 'Please enter a value no longer than %d characters.', IValidator::LENGTH => 'Please enter a value between %d and %d characters long.', IValidator::EMAIL => 'Please enter a valid email address.', IValidator::URL => 'Please enter a valid URL.', IValidator::INTEGER => 'Please enter a numeric value.', IValidator::FLOAT => 'Please enter a numeric value.', IValidator::RANGE => 'Please enter a value between %d and %d.', IValidator::UUID => 'Please enter a valid UUID.'];

    /** @var array Numeric expressions that needs to convert value from string (because of x-www-form-urlencoded) */
    protected static $numericExpressions = [IValidator::INTEGER, IValidator::FLOAT, IValidator::NUMERIC, IValidator::RANGE];
     ...
     * @param string $name
     */
    public function __construct($name, private IValidator $validator)
    {
        $this->name = $name;
    }
     ...
     */
    public function addRule($expression, $message = NULL, $argument = NULL, $code = 0): static
    {
        $rule = new Rule;
     ...
     * @return mixed
     */
    protected function parseNumericValue(mixed $value)
    {

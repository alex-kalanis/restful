...
Resource output is determined by `Accept` header. Library checks the header for
...
That's it! It is not exact the way like Nette but it's pretty similar. At least the base
public interface.
